...
<form method="post" action="{if $add}{'csv_import/add_config'|ezurl( 'no' )}{else}{concat( 'csv_import/edit_config/', $config.id )|ezurl( 'no' )}{/if}">

	<div class="context-block">
		<div class="box-header">
			<h1 class="context-title">{if $add}{'New Configuration'|i18n( 'extension/nxc_import' )}{else}{'Edit Configuration'|i18n( 'extension/nxc_import' )}{/if}</h1>
