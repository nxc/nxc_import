...
$config = nxcCSVImportDBConfig::fetch( $Params['ConfigID'] );
if( ( $r = $config->proccessHTTPInput( $Params['Module'], $http, true ) ) !== true ) {
	return $r;
}
...
$Result['path']      = array(
	...
	array(
		'text' => ezpI18n::tr( 'extension/nxc_import', 'Edit Configuration' ),
		'url'  => false
	)
);
